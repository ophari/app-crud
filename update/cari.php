<?php
    ...
    if(isset($_GET['cari'])){
    $cari= $_GET['cari']; 
    $select=mysqli_query($koneksi,"SELECT * FROM data_siswa WHERE id='$cari'");
    }
...
<body> 
    <?php 
        ...
        <div class="input-container mt-30">
            <input id="namalengkap" class="input" type="text" name="nama_lengkap"value="<?php echo $data['nama_lengkap']?>" required>
            <div class="cut">
            </div>
